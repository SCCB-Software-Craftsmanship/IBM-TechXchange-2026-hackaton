...
export const prerequisites = [
  { name: 'Node.js', version: '>= 22', why: 'Cloudant CLI scripts and this site' },
  { name: 'gh CLI', version: 'authenticated', why: 'Every workflow is workflow_dispatch only' },
  { name: 'Bob', version: 'any', why: 'Runs the skills and orchestrators' },
  { name: 'OpenTofu', version: '>= 1.6', why: 'Only if you provision your own Cloudant' },
]
...
open orchestrate/main.orchestrate.md as a task`,
        note: 'Produces .bob/ — PROJECT, ARCHITECTURE, TESTING, DEPENDENCIES, CONVENTIONS, GLOSSARY, TEST-SUITES and HEURISTICS.',
      },
      {
        id: 'prep',
        ...
        code: `bob -p "run testability-prep on PR #42"`,
      },
      {
        id: 'generate',
